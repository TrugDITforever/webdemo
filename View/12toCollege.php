            ...
            <div class="group">
              <div class="group-img">
                <div style="width: 50%; margin-right: 10px">
                  <a>
                    <img src="https://xcdn-cf.vuihoc.vn/upload/5c209fe6176b0/2022/04/06/097a_khoi-d-gom-nhung-nganh-nao-1.png" alt="" />
                  </a>
                </div>
                <div style="
                      display: flex;
      ...
      <div class="group-create">
        ...
        <form>
          ...
          <div class="login-form" id="loginform">
            ...
            <input type="text"  name="decrip" required placeholder="Nhập email của thành viên" />
          </div>

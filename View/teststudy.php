      ...
      <div class="all">
        <section class="start" id="home">
          <div class="introduce">
            ...
            <div class="rightside">
              <div class="welcome">
                <h1>CHÀO MỪNG MỌI NGƯỜI ĐẾN VỚI <span>LEARN X2</span></h1>
                <p>
                  LearnX2 mang đến cho các bạn học những giáo án hay phục vụ cho
                  việc học, bên cạnh đó còn có các dạng đề dành cho các lứa tuổi
                  từ lớp 1 đến lớp 12
                </p>
              </div>
            </div>
        ...
        <section class="about" id="about">
          <div class="aboutt">
            <div class="understart">
              <div class="worrd">
                <div class="shadow"><p>LỘ TRÌNH HỌC</p></div>
              </div>
              <div class="primary">
                <div class="left-pri">
                  <div class="img1">
        ...
        <section class="next">
          <div class="mainnext">
            <div class="worrd">
              <div class="shadow"><p>ÔN LUYỆN</p></div>
            </div>
            <div class="undernext">
              <div class="leftnext">
                <div class="word1">
                ...
                <div class="word3">
                  <h1 class="opacity3">LỚP 12 VÀ ÔN LUYỆN THI THPT</h1>
                </div>
                <div class="word2">
                  <h1 class="opacity2">LỚP 9 VÀ ÔN LUYỆN VÀO LỚP 10</h1>
                </div>
                <div class="arroww">
                  <div class="arrow1">
        ...
        <section class="lastt" id="llast">
          <div class="lastt2">
            <div class="alllast2">
              <div class="leftlast">
                <div class="under-leftlast">
                  <div class="worddd">
